...
const NaverLogin = ({ setGetToken, setUserInfo }) => {
	const { naver } = window
	const NAVER_CLIENT_ID = "7tDCULCxcIkhj6NJ98TQ"// 발급 받은 Client ID 입력 
	const NAVER_CALLBACK_URL = "http://localhost:3000/callback"// 작성했던 Callback URL 입력
  const secretKey = "n8mU2Jpag3"
...
const App = () => {
  return (
    <>
      <h1>Web3auth Naver login example</h1>
      <NaverLogin />
      <button onClick={tokenfunc}>print access token</button>
    </>
